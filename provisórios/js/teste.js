...
<div class="header-carteira">
    ...
    <span class="header-direita-carteira"><span>MUNICÍPIO: </span><span id="municipio">São José dos Campos</span></span> 
</div>
<div class="corpo-carteira">

<div class="contato-carteira">
     <img class="foto-carteira" src="img/placeholder-usuario-500x500.jpg" alt="Placeholder Foto">
    ...
    <p class="valor-carteira">VALOR DA HORA: <span>R$ </span><span id="valor">150</span><span>,00</span></p>
</div>

    <div class="informacoes-carteira">
        <p id="nome-usuario">América Souza Augusto da Silva</p>
        <p class="detalhes-carteira">CARRO: <span id="marca-carro">VOLKSWAGEN</span><span> (</span><span id="ano-carro">2017</span><span>)</span></p>
        <p class="detalhes-carteira">EXPERIÊNCIA: <span id="experiencia">15</span><span> ANOS</span></p>
